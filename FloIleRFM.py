# -*- coding: utf-8 -*-
"""
Created on Fri Jan 27 13:05:18 2023

@author: Gokhan Yıldız
"""
...
## Icerisinde date kelimesi gecen columnslari date_colums adi altinda bir degiskene cevirir
...
df_agg=df.groupby("order_channel").agg({"master_id":"count",
                                 "order_num_total":"sum",
                                 "customer_value_total":"sum"})
#groupby edilen bir kodun gorsellestirilmesi
#df_agg.plot(kind='bar', y=["order_num_total"], stacked=False)
#plt.show()
